...
# ----------- Settings -----------
BASE_URL = "https://behappy.ucoz.com/sitemap.xml"  # sitemap start
OUTPUT_PDF_TXT = "behappy-pdf_txt_links.txt"
OUTPUT_VIDEO = "behappy-video_links.txt"
OUTPUT_YOUTUBE = "behappy-youtube_links.txt"
